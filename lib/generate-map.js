...
module.exports = () => new Promise(resolve => {
  ...
  const jmaDate = dt.toFormat('YYYYMMDD')
  const jmaTime = dt.toFormat('YYYYMMDDHH24MISS')
  log(date, time, jmaDate, jmaTime)
  ...
  const imagepathArary = [
    ...
    {name: 'rtshindo', url: `http://www.kmoni.bosai.go.jp/new/data/map_img/RealTimeImg/jma_s/${jmaDate}/${jmaTime}.jma_s.gif`, path: `${tempDir}/rtshindo.gif`}
  ]
